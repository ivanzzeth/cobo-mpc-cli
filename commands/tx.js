...
export function createTxCommand() {
  ...
  txCommand
    ...
    .option('--cobo-ids <ids>', 'Filter by Cobo IDs (comma-separated)')
    .option('--transaction-hashes <hashes>', 'Filter by transaction hashes (comma-separated)')
    .option('--token-ids <ids>', 'Filter by token IDs (comma-separated)')
    .option('--asset-ids <ids>', 'Filter by asset IDs (comma-separated)')
    .option('--vault-id <id>', 'Filter by vault ID')
    .option('--wallet-type <type>', 'Filter by wallet type: Custodial, MPC, SmartContract, Exchange')
    .option('--wallet-subtype <subtype>', 'Filter by wallet subtype: Asset, Web3, Org-Controlled, User-Controlled, Safe{Wallet}, Main, Sub')
    .option('--project-id <id>', 'Filter by project ID (User-Controlled Wallets only)')
    .option('--min-created-timestamp <timestamp>', 'Filter by minimum created timestamp (milliseconds)')
    .option('--max-created-timestamp <timestamp>', 'Filter by maximum created timestamp (milliseconds)')
